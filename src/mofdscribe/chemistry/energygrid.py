...
class EnergyGridHistogram(BaseFeaturizer):
    ...
    def __init__(
        ...
        Args:
            ...
            histogram. Defaults to 1. min_energy_vdw (float, optional): Minimum
            ...
            Defaults to 12. mof_ff (str, optional): Name of the forcefield used
            for the framework. Defaults to "UFF". mol_ff (str, optional): Name
            of the forcefield used for the guest molecule. Defaults to "TraPPE".
            mol_name (str, optional): Name of the guest molecule. Defaults to
            "CO2". sites (Tuple[str], optional): Name of the Van-der-Waals sites
