...
class PartialChargeHistogram(BaseFeaturizer):
    ...
    def __init__(
        ...
        Args:
            min_charge (float, optional): Minimum limit of bin grid. Defaults to
            -4. max_charge (float, optional): Maximum limit of bin grid.
            Defaults to 4. bin_size (float, optional): Bin size. Defaults to
            0.5.
        """
