...
class PHImage(BaseFeaturizer):
    ...
    def __init__(
        ...
        Args:
            ...
            image_size (Tuple[int], optional): Size of persistent image in pixel. Defaults
                to (20, 20).
            spread (float, optional): "Smearing factor" for the
                Gaussians. Defaults to 0.2. weight (str, optional): Weighting
                function for calculation of the persistence images.
                Defaults to "identity".
            max_B (Union[int, List[int]], optional): Maximum birth time.
                Defaults to 18. max_P (Union[int, List[int]], optional): Maximum
